    ...
    <div class="container-xxl">
        ...
        <div class="row align-items-center">
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    <h3 class="fw-bold mb-0"><span><a href="javascript:history.back()"><i class="icofont-block-left fs-3" title="Back"></i></a></span> Lens Features</h3>
                </div>
            </div>
        </div> <!-- Row end  -->  
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-xl-6 col-lg-6" id="addForm">
                <form method="post" action="<?php echo base_url(); ?>/save-lens-feature" enctype="multipart/form-data">
                <div class="card mb-3">
                        ...
                        <table id="myDataTable" class="table table-hover align-middle mb-0" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>#<?= $n++; ?></td>
                                    <td>
                                        <img class="w120 rounded img-fluid" src="<?php echo base_url(); ?>/images/lensfeatures/<?= $value->image; ?>" alt="" style="height: 60px; object-fit: contain;">
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic outlined example">
                                             ...
                                             <a href="<?php echo base_url(); ?>/edit-lens-feature/<?php echo $value->id;?>" class="btn btn-outline-secondary btnedit" title="Edit"><i class="icofont-edit text-success"></i></a>
                                            <a href="javascript:void(0);" onclick="confirmDelete('<?php echo base_url(); ?>/delete-lens-feature/<?php echo $value->id;?>')" class="btn btn-outline-secondary deleterow" title="Delete">
