        ...
        <div class="row align-items-center">
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    <h3 class="fw-bold mb-0"><span><a href="javascript:history.back()"><i class="icofont-block-left fs-3" title="Back"></i></a></span> Checklist Report</h3>
                </div>
            </div>
        </div> <!-- Row end  -->
        <div class="row align-items-center">
...
<script>
    $(document).ready(function () {
        ...
        var table = $('#myDataTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo base_url(); ?>/get-checklist-report-by-date',
                type: 'POST',
                data: function (d) {
            ...
            columnDefs: [
                ...
                { targets: 3, render: function (data, type, row) {
                    ...
                    return `
                        <div class="btn-group">
                            <a href="<?php echo base_url(); ?>/view-checklist/${row.id}" type="button" class="btn btn-outline-secondary" title="View">
                                <i class="icofont-eye-alt text-success"></i>
                            </a>

                            <a href="javascript:void(0);" onclick="confirmDelete('<?php echo base_url(); ?>/checklists-delete/${row.id}')" class="btn btn-outline-secondary deleterow" title="Delete">
