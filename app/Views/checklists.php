        ...
        <div class="row align-items-center">
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    ...
                    <a href="<?php echo base_url(); ?>/add-checklist" class="btn btn-primary py-2 px-5 btn-set-task w-sm-100"><i class="icofont-plus-circle me-2 fs-6"></i> Add Check List</a>
                </div>
            </div>
        </div> <!-- Row end  -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic outlined example">
                                            <a href="<?php echo base_url(); ?>/edit-checklist/<?= $value->id;?>" class="btn btn-outline-secondary" title="Edit"><i class="icofont-edit text-success"></i></a>
                                            <a href="javascript:void(0);" onclick="confirmDelete('<?php echo base_url(); ?>/delete-checklist/<?= $value->id;?>')" class="btn btn-outline-secondary deleterow" title="Delete">
