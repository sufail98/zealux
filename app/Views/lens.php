    ...
    <div class="container-xxl">
        ...
        <div class="row align-items-center">
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    <h3 class="fw-bold mb-0"><span><a href="javascript:history.back()"><i class="icofont-block-left fs-3" title="Back"></i></a></span> Lens</h3>
                </div>
            </div>
        </div> <!-- Row end  -->  
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-xl-6 col-lg-6" id="addForm">
                <form method="post" action="<?php echo base_url(); ?>/save-lens" enctype="multipart/form-data">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row g-3 align-items-center">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="lens" required>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-6 col-lg-6" id="editForm">
                <form method="post" action="<?php echo base_url(); ?>/Lens/UpdateLens" enctype="multipart/form-data">
                <div class="card mb-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic outlined example">
                                            ...
                                            <a href="javascript:void(0);" onclick="confirmDelete('<?php echo base_url(); ?>/delete-lens/<?php echo $value->id;?>')" class="btn btn-outline-secondary deleterow" title="Delete">
...
<script>
    $(document).ready(function(){
        ...
        $('.btnedit').on('click',function(){
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>/get-lens',
                type: 'GET',
                data: { id: lensId },
                dataType: 'json',
                success: function(response) {
                    if (response.status === 'success') {
                        var lens = response.data;
                        $('#editForm').find('input[name="lens"]').val(lens.lens_name);
                        $('#editForm').find('input[name="id"]').val(lens.id);
                        
                        $('#addForm').hide();
                        $('#editForm').show();
                    } else {
                        alert('Failed to load lens details.');
                    }
                },
                error: function() {
                    alert('An error occurred while fetching the lens details.');
                }
            });
        });
    });
