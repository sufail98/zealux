...
<div class="body d-flex py-3" id="topsec">
    <div class="container-xxl">
        ...
        <form method="post" action="<?php echo base_url(); ?>/update-breakage-warranty" enctype="multipart/form-data">
        <div class="row align-items-center">
            <div class="border-0 mb-3">
                <div class="card-header no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    <h3 class="fw-bold mb-0"><span><a href="javascript:history.back()"><i class="icofont-block-left fs-3" title="Back"></i></a></span> Edit Warranty</h3>
                ...
                <div class="card" >
                    ...
                    <div class="card-body">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="card">
                                <div class="card-body">
                                  <input type="text" name="id" value="<?= $editdata[0]->id; ?>" hidden>
                                    ...
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-md-3">
                                           <label  class="form-label">Price From <span style="color: #f00; font-size: 15px;">*</span></label>
                                            <input type="number" class="form-control" name="price_from" value="<?= $editdata[0]->price_from; ?>" required>
                                        </div>
                                        <div class="col-md-3">
                                           <label  class="form-label">Price To <span style="color: #f00; font-size: 15px;">*</span></label>
                                            <input type="number" class="form-control" name="price_to" value="<?= $editdata[0]->price_to; ?>" required>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9">
                                           <label  class="form-label">Description </label>
                                            <textarea class="form-control" name="desc"><?= $editdata[0]->decsription; ?></textarea>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <table id="myCartTable" class="table display dataTable table-hover align-middle" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $features = explode(' | ', $editdata[0]->features);  ?>
                                                    <?php foreach ($features as $feature): ?>
                                                    <tr class="tabRow">
  
                                                        <td>
                                                            <input type="text" class="form-control" placeholder="Feature.." name="features[]" value="<?= $feature; ?>" >
                                                        </td>
