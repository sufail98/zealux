    ...
    <div class="container-xxl">
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-xl-6 col-lg-6" id="editForm">
                <form method="post" action="<?php echo base_url(); ?>/update-lens-feature" enctype="multipart/form-data">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-md-12">
                                ...
                                <img id="loadImage" src="<?php echo base_url(); ?>/images/lensfeatures/<?= $editdata->image; ?>" style="height: 100px; margin-top: 20px; margin-bottom: 20px;">
