        ...
        <div class="row align-items-center">
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    <h3 class="fw-bold mb-0"><span><a href="javascript:history.back()"><i class="icofont-block-left fs-3" title="Back"></i></a></span> Purchase List</h3>
                </div>
            </div>
        </div> <!-- Row end  -->
        <div class="row align-items-center">
...
<script>
    $(document).ready(function () {
        ...
        var table = $('#myDataTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo base_url(); ?>/get-purchase-report-by-date',
                type: 'POST',
                data: function (d) {
                    d.search.value
            ...
            columnDefs: [
                ...
                { targets: 3, render: function (data, type, row) {
                    ...
                    return `
                        <div class="btn-group">
                            <a href="<?php echo base_url(); ?>/edit-purchase/${row.purchase_id}" class="btn btn-outline-secondary" title="Edit"><i class="icofont-edit text-success"></i></a>

                            <button onclick="confirmDelete('<?php echo base_url(); ?>/delete-purchase/${row.purchase_id}')" class="btn btn-outline-secondary" title="Delete">
