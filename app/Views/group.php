    ...
    <div class="container-xxl">
        ...
        <div class="row align-items-center">
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    <h3 class="fw-bold mb-0"><span><a href="javascript:history.back()"><i class="icofont-block-left fs-3" title="Back"></i></a></span> Groups</h3>
                </div>
            </div>
        </div> <!-- Row end  -->  
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-xl-6 col-lg-6" id="addForm">
                <form method="post" action="<?php echo base_url(); ?>/save-group" enctype="multipart/form-data">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="form-check-inline">
                                <input class="form-check-input" type="checkbox" name="isPrivilegeApplied" value="1" >
                                <label class="form-check-label" for="isPrivilegeApplied">
                                    Is Privilege Applied
                                </label>
                            </div>
            ...
            <div class="col-xl-6 col-lg-6" id="editForm">
                <form method="post" action="<?php echo base_url(); ?>/update-group" enctype="multipart/form-data">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="form-check-inline">
                                <input class="form-check-input" type="checkbox" name="isPrivilegeApplied" value="1" id="isPrivilegeApplied" >
                                <label class="form-check-label" for="isPrivilegeApplied">
                                    Is Privilege Applied
                                </label>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic outlined example">
                                            ...
                                            <!-- <a href="<?php echo base_url(); ?>/Groups/GroupDelete/<?php echo $value->id;?>" type="button" class="btn btn-outline-secondary deleterow" onclick="return confirm('Are you sure to Delete?')" title="Delete"><i class="icofont-ui-delete text-danger"></i></a> -->

                                            <a href="javascript:void(0);" onclick="confirmDelete('<?php echo base_url(); ?>/delete-group/<?php echo $value->id;?>')" class="btn btn-outline-secondary deleterow" title="Delete">
...
<script>
    $(document).ready(function(){
        ...
        $('.btnedit').on('click',function(){
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>/get-group',
                type: 'GET',
                data: { id: groupId },
                dataType: 'json',
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        $('#editForm').find('input[name="group"]').val(group.group_name);
                        $('#editForm').find('input[name="id"]').val(group.id);
                        if (group.isPrivilegeApplied == 1) {
                            $('#editForm').find('input[name="isPrivilegeApplied"]').prop('checked', true);
                        } else {
                            $('#editForm').find('input[name="isPrivilegeApplied"]').prop('checked', false);
                        }
