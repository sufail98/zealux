<?php include'header.php'; ?>
    ...
    <div class="body d-flex py-lg-3 py-md-2">
        <div class="container-xxl">
            ...
            <form method='post' action='<?php echo base_url();?>/update-stock-tranfer'>
            <input type="text" name="tid" value="<?= $editdata[0]->tid; ?>" hidden>
                          ...
                          <table class="meta">
                            <tbody>
                              <tr>
                                ...
                                <td>
                                    <select class="form-select" aria-label="" name="from_store" required>
                                        ...
                                        <option value="<?php echo $fstores->storeId; ?>" <?php if($editdata[0]->from_store == $fstores->storeId){echo 'selected=""';}?>><?php echo $fstores->store_name; ?></option>
                                        <?php } ?>
                                    </select>
                                </td>
                              </tr>
                              <tr>
                                ...
                                <td>
                                    <select class="form-select" aria-label="" name="to_store" required>
                                        ...
                                        <option value="<?= $tstores->storeId; ?>" <?php if($editdata[0]->to_store == $fstores->storeId){echo 'selected=""';}?>><?= $tstores->store_name; ?></option>
                                        <?php } ?>
                                    </select>
                                </td>
                              </tr>
                              <tr>
                                ...
                                <td><input type="date" class="form-control" name="pdate" value="<?= $editdata[0]->transfer_date; ?>"/></td>
                              </tr>
                              <tr>
