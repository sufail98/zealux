...
<div class="body d-flex py-3" id="topsec">
    <div class="container-xxl">
        ...
        <form method="post" action="<?php echo base_url(); ?>/update-eye-test" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-md-3">
                                           <label  class="form-label">Register Date <span style="color: #f00; font-size: 15px;">*</span></label>
                                            <input type="date" class="form-control" name="testdate" value="<?php echo $editdata[0]->Test_date; ?>" required>
                                        </div>
                                        <div class="col-md-3">
                                           <label  class="form-label">Customer Name <span style="color: #f00; font-size: 15px;">*</span></label>
                                            <input type="text" class="form-control" name="cutomer" value="<?php echo $editdata[0]->CustomerName; ?>" required>
                                        </div> 
                                        <div class="col-md-3">
                                            <label  class="form-label">Age <span style="color: #f00; font-size: 15px;">*</span></label>
                                            <input type="number" class="form-control" name="age" value="<?php echo $editdata[0]->CustomerAge; ?>" required>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="c_history" rows="2" class="form-control"> <?php echo $editdata[0]->CustomerHistory; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-4">
                                           <label  class="form-label">Occupation </label>
                                            <select class="form-select" aria-label="Default select example" name="occupation" >
                                                ...
                                                <option value="Salaried" <?php if($editdata[0]->Occupation == 'Salaried'){echo 'selected=""';}?>>Salaried</option>
                                                <option value="Business" <?php if($editdata[0]->Occupation == 'Business'){echo 'selected=""';}?>>Business</option>
                                                <option value="Student" <?php if($editdata[0]->Occupation == 'Student'){echo 'selected=""';}?>>Student</option>
                                                <option value="Others" <?php if($editdata[0]->Occupation == 'Others'){echo 'selected=""';}?>>Others</option>
                                            </select>   
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-select" aria-label="Default select example" name="digitalusage">
                                                ...
                                                <option value="3HRS" <?php if($editdata[0]->digital_usage == '3HRS'){echo 'selected=""';}?>>3HRS</option>
                                                <option value="4HRS" <?php if($editdata[0]->digital_usage == '4HRS'){echo 'selected=""';}?>>4HRS</option>
                                                <option value="5HRS" <?php if($editdata[0]->digital_usage == '5HRS'){echo 'selected=""';}?>>5HRS</option>
                                                <option value="6HRS" <?php if($editdata[0]->digital_usage == '6HRS'){echo 'selected=""';}?>>6HRS</option>
                                                <option value="7HRS" <?php if($editdata[0]->digital_usage == '7HRS'){echo 'selected=""';}?>>7HRS</option>
                                                <option value="8HRS" <?php if($editdata[0]->digital_usage == '8HRS'){echo 'selected=""';}?>>8HRS</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="card step" id="step-3" style="display:none;">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="" class="table display cust-border-none dataTable table-hover align-middle" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php $ARPower = json_decode($editdata[0]->ARPower, true); ?>
                                            <tr>
                                                <td>SPH</td>
                                                <td><input type="text" class="form-control" name="sph_right" value="<?= !empty($ARPower['right']['sph']) ? $ARPower['right']['sph'] : '' ?>"></td>
                                                <td><input type="text" class="form-control" name="sph_left" value="<?= !empty($ARPower['left']['sph']) ? $ARPower['left']['sph'] : '' ?>"></td>
                                            </tr>
                                            <tr>
                                                <td>CYL</td>
                                                <td><input type="text" class="form-control" name="cyl_right" value="<?= !empty($ARPower['right']['cyl']) ? $ARPower['right']['cyl'] : '' ?>"></td>
                                                <td><input type="text" class="form-control" name="cyl_left" value="<?= !empty($ARPower['left']['cyl']) ? $ARPower['left']['cyl'] : '' ?>"></td>
                                            </tr>
                                            <tr>
                                                <td>ADD</td>
                                                <td><input type="text" class="form-control" name="add_right" value="<?= !empty($ARPower['right']['add']) ? $ARPower['right']['add'] : '' ?>"></td>
                                                <td><input type="text" class="form-control" name="add_left" value="<?= !empty($ARPower['left']['add']) ? $ARPower['left']['add'] : '' ?>"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <div class="card-header d-flex justify-content-between align-items-center bg-transparent border-bottom-0">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <img id="loadImage" src="<?php echo base_url(); ?>/images/eyetest/<?= $editdata[0]->ARPower_photo; ?>" style="height: 100px; margin-top: 20px; margin-bottom: 20px;">
                                        <input type="file" class="form-control" name="capturephoto" id="capturephoto" onchange="previewImages(this)">
                            ...
                            <div class="card step" id="step-4" style="display:none;">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="" class="table display cust-border-none dataTable table-hover align-middle" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php $unaidedVision = json_decode($editdata[0]->unaidedVision, true); ?>
                                            <tr>
                                                <td>Distance Vision</td>
                                                <td><input type="text" class="form-control" name="unaided_dist_vision_right" value="<?= !empty($unaidedVision['right']['Distance Vision']) ? $unaidedVision['right']['Distance Vision'] : '' ?>"></td>
                                                <td><input type="text" class="form-control" name="unaided_dist_vision_left" value="<?= !empty($unaidedVision['left']['Distance Vision']) ? $unaidedVision['left']['Distance Vision'] : '' ?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Near Vision</td>
                                                <td><input type="text" class="form-control" name="unaided_near_vision_right" value="<?= !empty($unaidedVision['right']['Near Vision']) ? $unaidedVision['right']['Near Vision'] : '' ?>"></td>
                                                <td><input type="text" class="form-control" name="unaided_near_vision_left" value="<?= !empty($unaidedVision['left']['Near Vision']) ? $unaidedVision['left']['Near Vision'] : '' ?>"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table id="" class="table display cust-border-none dataTable table-hover align-middle" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php $pinholeVision = json_decode($editdata[0]->pinholeVision, true); ?>
                                            <tr>
                                                <td>Distance Vision</td>
                                                <td><input type="text" class="form-control" name="pinhole_dist_vision_right" value="<?= !empty($pinholeVision['right']['Distance Vision']) ? $pinholeVision['right']['Distance Vision'] : '' ?>"></td>
                                                <td><input type="text" class="form-control" name="pinhole_dist_vision_left" value="<?= !empty($pinholeVision['left']['Distance Vision']) ? $pinholeVision['left']['Distance Vision'] : '' ?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Near Vision</td>
                                                <td><input type="text" class="form-control" name="pinhole_near_vision_right" value="<?= !empty($pinholeVision['right']['Near Vision']) ? $pinholeVision['right']['Near Vision'] : '' ?>"></td>
                                                <td><input type="text" class="form-control" name="pinhole_near_vision_left" value="<?= !empty($pinholeVision['left']['Near Vision']) ? $pinholeVision['left']['Near Vision'] : '' ?>"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table id="" class="table display cust-border-none dataTable table-hover align-middle" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php $pgpVision = json_decode($editdata[0]->pgpVision, true); ?>
                                            <tr>
                                                <td>Distance Vision</td>
                                                <td><input type="text" class="form-control" name="pgp_dist_vision_right" value="<?= !empty($pgpVision['right']['Distance Vision']) ? $pgpVision['right']['Distance Vision'] : '' ?>"></td>
                                                <td><input type="text" class="form-control" name="pgp_dist_vision_left" value="<?= !empty($pgpVision['left']['Distance Vision']) ? $pgpVision['left']['Distance Vision'] : '' ?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Near Vision</td>
                                                <td><input type="text" class="form-control" name="pgp_near_vision_right" value="<?= !empty($pgpVision['right']['Distance Vision']) ? $pgpVision['right']['Distance Vision'] : '' ?>"></td>
                                                <td><input type="text" class="form-control" name="pgp_near_vision_left" value="<?= !empty($pgpVision['left']['Distance Vision']) ? $pgpVision['left']['Distance Vision'] : '' ?>"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="card step" id="step-5" style="display:none;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-5">
                                            <div class="form-check-inline">
                                                <input class="form-check-input" type="radio" name="flashtourch" value="Normal" <?php if($editdata[0]->FlashTourch == 'Normal'){echo 'checked=""';}?>>
                                                <label class="form-check-label">
                                                    Normal
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                                <input class="form-check-input" type="radio" name="flashtourch" value="Upnormal" <?php if($editdata[0]->FlashTourch == 'Upnormal'){echo 'checked=""';}?>>
                                                <label class="form-check-label">
                                                    Upnormal
                                                </label>
                                            </div>
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <textarea name="flashdesc" rows="2" class="form-control"><?php echo $editdata[0]->FlashTourchDiscription; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-5">
                                            <div class="form-check-inline">
                                                <input class="form-check-input" type="radio" name="coveruncovertest" value="Normal" <?php if($editdata[0]->CoverUnCoverTest == 'Normal'){echo 'checked=""';}?>>
                                                <label class="form-check-label">
                                                    Normal
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                                <input class="form-check-input" type="radio" name="coveruncovertest" value="Upnormal" <?php if($editdata[0]->CoverUnCoverTest == 'Upnormal'){echo 'checked=""';}?>>
                                                <label class="form-check-label">
                                                    Upnormal
                                                </label>
                                            </div>
                                        ...
                                        <div class="col-md-7">
                                            <label  class="form-label">Description</label>
                                            <textarea name="coveruncovertestdesc" rows="2" class="form-control"><?php echo $editdata[0]->CoverUnCoverTestDescription; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-5">
                                            <div class="form-check-inline">
                                                <input class="form-check-input" type="radio" name="convergencetest" value="Normal" <?php if($editdata[0]->ConverganceTest == 'Normal'){echo 'checked=""';}?>>
                                                <label class="form-check-label">
                                                    Normal
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                                <input class="form-check-input" type="radio" name="convergencetest" value="Upnormal" <?php if($editdata[0]->ConverganceTest == 'Upnormal'){echo 'checked=""';}?>>
                                                <label class="form-check-label">
                                                    Upnormal
                                                </label>
                                            </div>
                                        ...
                                        <div class="col-md-7">
                                            <label  class="form-label">Description</label>
                                            <textarea name="convergencetestdesc" rows="2" class="form-control"> <?php echo $editdata[0]->ConverganceTestDescription; ?></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="card step" id="step-6" style="display:none;">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="" class="table display cust-border-none dataTable table-hover align-middle" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php $PDMeasurement = json_decode($editdata[0]->PDMeasurement, true); ?>
                                            <tr>
                                                <td><input type="text" class="form-control" name="pd_right" value="<?= !empty($PDMeasurement['pd_right']) ? $PDMeasurement['pd_right'] : '' ?>"></td>
                                                <td><input type="text" class="form-control" name="pd_left" value="<?= !empty($PDMeasurement['pd_left']) ? $PDMeasurement['pd_left'] : '' ?>"></td>
                                                <td><input type="text" class="form-control" name="pd_both" value="<?= !empty($PDMeasurement['pd_both']) ? $PDMeasurement['pd_both'] : '' ?>"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="card step" id="step-7" style="display:none;">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="" class="table display cust-border-none dataTable table-hover align-middle" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php $Duochrome = json_decode($editdata[0]->Duochrome, true); ?>
                                            <tr>
                                                <td>Red</td>
                                                <td><input type="text" class="form-control" name="duochrome_red_right" value="<?= !empty($Duochrome['right']['red']) ? $Duochrome['right']['red'] : '' ?>"></td>
                                                <td><input type="text" class="form-control" name="duochrome_red_left" value="<?= !empty($Duochrome['left']['red']) ? $Duochrome['left']['red'] : '' ?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Green</td>
                                                <td><input type="text" class="form-control" name="duochrome_green_right" value="<?= !empty($Duochrome['right']['green']) ? $Duochrome['right']['green'] : '' ?>"></td>
                                                <td><input type="text" class="form-control" name="duochrome_green_left" value="<?= !empty($Duochrome['left']['green']) ? $Duochrome['left']['green'] : '' ?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Both are same</td>
                                                <td><input type="text" class="form-control" name="duochrome_both_right" value="<?= !empty($Duochrome['right']['both']) ? $Duochrome['right']['both'] : '' ?>"></td>
                                                <td><input type="text" class="form-control" name="duochrome_both_left" value="<?= !empty($Duochrome['left']['both']) ? $Duochrome['left']['both'] : '' ?>"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-12">
                                            <div class="form-check-inline">
                                                <input class="form-check-input" type="radio" name="jcc" value="Refined" <?php if($editdata[0]->JCC == 'Refined'){echo 'checked=""';}?>>
                                                <label class="form-check-label">
                                                    Refined
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                                <input class="form-check-input" type="radio" name="jcc" value="Not Refined" <?php if($editdata[0]->JCC == 'Not Refined'){echo 'checked=""';}?>>
                                                <label class="form-check-label">
                                                    Not Refined
                                                </label>
                                            </div>
                            ...
                            <div class="card step" id="step-9" style="display:none;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-12">
                                            <div class="">
                                                <label class="form-label">Usage </span></label>
                                            </div>
                                            <div class="form-check-inline">
