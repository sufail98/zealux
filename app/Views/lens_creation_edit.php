...
<div class="body d-flex py-3">
    <div class="container-xxl">
        ...
        <form method="post" action="<?php echo base_url(); ?>/update-lens-creation" enctype="multipart/form-data">
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-xl-8 col-lg-8">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <input type="text" name="lid" value="<?php echo $editdata[0]->lensId; ?>" hidden>

                        <div class="row g-3 align-items-center">
                            <div class="col-md-6">
                               <label  class="form-label">Name <span style="color: #f00; font-size: 15px;">*</span></label>
                                <input type="text" class="form-control" name="lensname" required value="<?php echo $editdata[0]->lensName; ?>">
                            </div> 
                            <div class="col-md-6">
                               <label  class="form-label">Lens Type <span style="color: #f00; font-size: 15px;">*</span></label>
                                <select class="form-select" aria-label="" name="lens" required>
                                    ...
                                    <option value="<?php echo $lens->id; ?>" <?php if($lens->id==$editdata[0]->lens){echo 'selected=""';}?>><?php echo $lens->lens_name; ?></option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" name="purchaserate" value="<?php echo $editdata[0]->purchaseRate; ?>">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" name="delivery_days" value="<?= $editdata[0]->delivery_days; ?>" required>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="sticky-lg-top">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            $efeatures = explode(',', $editdata[0]->lensFeaturesId);  ?>
