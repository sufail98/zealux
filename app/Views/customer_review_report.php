        ...
        <div class="row align-items-center">
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    <h3 class="fw-bold mb-0"><span><a href="javascript:history.back()"><i class="icofont-block-left fs-3" title="Back"></i></a></span> Customer Review</h3>
                </div>
            </div>
        </div> <!-- Row end  -->
        <div class="row align-items-center">
...
<script>
    $(document).ready(function () {
        ...
        var table = $('#myDataTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo base_url(); ?>/get-customer-review-report-by-date',
                type: 'POST',
                data: function (d) {
            ...
            columnDefs: [
                ...
                { targets: 7, render: function (data, type, row) {
                    ...
                    return `
                        <div class="btn-group">
                            ${row.phone !== '' ?
                            `<a href="https://wa.me/${row.phone}?text=${encodeURIComponent(`Thank you for your purchase! Please write a review. Here is your Review link: ${baseUrl}/customer-review/?bill_no=${row.invoice_no}`)}" type="button" class="btn btn-outline-success" title="WhatsApp" target="_blank">
